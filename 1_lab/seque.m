function [ret,x0,str,ts,xts]=seque(t,x,u,flag);
%SEQUE	is the M-file description of the SIMULINK system named SEQUE.
%	SEQUE has a the following characteristics:
%		0 continuous states
%		0 discrete states
%		0 outputs
%		0 inputs
...
%		1 sample times
%
%	The block-diagram can be displayed by typing: SEQUE.
%
%	SYS=SEQUE(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes SEQUE to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling SEQUE with a FLAG of zero:
%	[SIZES]=SEQUE([],[],[],0),  returns a vector, SIZES, which
...
set_param([sys,'/',['Repeating',13,'Sequence']],...
		...
		'Mask Entries','[0 0.2 0.5 0.9]\/[0 1 10 5]\/')
